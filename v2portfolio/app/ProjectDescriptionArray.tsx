...
export const ProjectDescriptionArray: ProjectDescriptionProps[] = [
  {
    ...
    description: (
      <div>
        <p>
          'CookSuccess' is where I honed my backend skills. The inspiration for
          'CookSuccess' came from having a lot of ingredients in my kitchen, and
  ...
  },
  {
    ...
    description: (
      <div>
        <p>
          'Whack-a-Food' is unique to this portfolio because it is not a
          website, and it was from a tutorial. It is the capstone project for
