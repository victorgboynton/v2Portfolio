...
export default function Home() {
  return (
    <main className="flex flex-col font-robotoSlab">
      ...
      <div className="bg-gradient-to-t from-[#1a032b] to-[#330336]">
        <div
          id="aboutMeSection"
          ...
          <div className="pt-20 md:pt-32 flex flex-col md:flex-row mx-auto items-center justify-between">
            <div className="md:w-[60vw] mx-auto">
              <h1 className="text-center text-2xl font-bold pb-5">
                Hello! I&apos;m Victor Boynton
              </h1>
              <p>
                I am a software developer based out of Boulder, Colorado. I
                bring an Associates of Applied Science in Programming and a
                portfolio rich with diverse projects and freelance ventures.
              </p>
              <br />
              <p>
